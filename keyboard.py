...
Dis_entry.grid(rowspan=1, columnspan=1000, ipadx=9999, ipady=20)
...
backspace = ttk.Button(key, text='backspace', width=8, command=lambda: press('backspace'))
backspace.grid(row=1, column=12, ipadx=6, ipady=10)
...
slash.grid(row=2, column=11, ipadx=6, ipady=10)

enter  = ttk.Button(key, text='ENTER', width=6, command=lambda: press ('Enter'))
...
ctrl  = ttk.Button(key, text='ctrl', width=6, command=lambda: press ('ctrl'))
ctrl.grid(row=4, column=10, ipadx=6, ipady=10)                    
